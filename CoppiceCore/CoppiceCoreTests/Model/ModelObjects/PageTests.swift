...
class PageTests: XCTestCase {
    ...
    func test_plistRepresentation_containsTitle() throws {
        let page = Page()
        page.title = "Foobar"
        let title = try XCTUnwrap(page.plistRepresentation[.Page.title] as? String)
    ...
    func test_plistRepresentation_containsDateCreated() throws {
        ...
        let date = try XCTUnwrap(page.plistRepresentation[.Page.dateCreated] as? Date)
    ...
    func test_plistRepresentation_containsDateModified() throws {
        ...
        let date = try XCTUnwrap(page.plistRepresentation[.Page.dateModified] as? Date)
    ...
    func test_plistRepresentation_containsUserPreferredSizeIfSet() throws {
        ...
        let size = try XCTUnwrap(page.plistRepresentation[.Page.userPreferredSize] as? String)
    ...
    func test_plistRepresentation_doesntContainUserPreferredSizeIfSet() {
        let page = Page()
        XCTAssertNil(page.plistRepresentation[.Page.userPreferredSize])
    }
    ...
    func test_plistRepresentation_containsContentForTextContent() throws {
        ...
        let content = try XCTUnwrap(page.plistRepresentation[.Page.content] as? ModelFile)
    ...
    func test_updateFromPlistRepresentation_doesntUpdateIfIDsDontMatch() {
        ...
        let plist: [ModelPlistKey: Any] = [
            .id: "foobar",
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1234),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9876),
            .Page.content: ModelFile(type: "text", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesTitle() {
        ...
        let plist: [ModelPlistKey: Any] = [
            .id: page.id,
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1235),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9875),
            .Page.content: ModelFile(type: "text", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesDateCreated() {
        ...
        let plist: [ModelPlistKey: Any] = [
            .id: page.id,
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1236),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9874),
            .Page.content: ModelFile(type: "text", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesDateModified() {
        ...
        let plist: [ModelPlistKey: Any] = [
            .id: page.id,
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1237),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9873),
            .Page.content: ModelFile(type: "text", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_throwsIfDateModifiedMissing() {
        ...
        let plist: [ModelPlistKey: Any] = [
            ...
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1237),
            .Page.content: ModelFile(type: "empty", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesUserPreferredSizeIfInPlist() {
        ...
        let plist: [ModelPlistKey: Any] = [
            ...
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1238),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9872),
            .Page.userPreferredSize: NSStringFromSize(CGSize(width: 320, height: 480)),
            .Page.content: ModelFile(type: "text", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesContentToTextContentIfTextContentInPlist() throws {
        ...
        let plist: [ModelPlistKey: Any] = [
            ...
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1238),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9872),
            .Page.content: ModelFile(type: "text", filename: "\(page.id.uuid.uuidString).rtf", data: data, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_updatesContentToImageContentIfImageContentInPlist() {
        ...
        let plist: [ModelPlistKey: Any] = [
            ...
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1238),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9872),
            .Page.content: ModelFile(type: "image", filename: "\(page.id.uuid.uuidString).png", data: data, metadata: ["description": "Hello World"]),
        ]
    ...
    func test_updateFromPlistRepresentation_throwsIfContentMissing() {
        ...
        let plist: [ModelPlistKey: Any] = [
            .id: page.id,
            .Page.title: "Lorem Ipsum",
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1239),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9871),
        ]
    ...
    func test_updateFromPlistRepresentation_throwsIfContentTypeIsNotValid() {
        ...
        let plist: [ModelPlistKey: Any] = [
            ...
            .Page.dateCreated: Date(timeIntervalSinceReferenceDate: 1238),
            .Page.dateModified: Date(timeIntervalSinceReferenceDate: 9872),
            .Page.content: ModelFile(type: "foobar", filename: nil, data: nil, metadata: nil),
        ]
    ...
    func test_updateFromPlistRepresentation_doesntIncludeAnySupportPlistKeysInOtherProperties() throws {
        ...
        for key in ModelPlistKey.Page.all {
