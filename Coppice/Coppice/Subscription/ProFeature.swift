...
extension ProFeature {
    var title: String {
        ...
        case .linkToExistingPages:  return NSLocalizedString("Link to Existing Pages", comment: "Link to Existing Pages upsell title")
    ...
    var body: String {
        ...
        case .linkToExistingPages:
            return NSLocalizedString("Sometimes a page is too important to only link to once. Coppice Pro lets multiple pages link to a single page. Either Command-Click a link on a Canvas or enable linking to existing pages by default in preferences.", comment: "Link to Existing Page upsell body")
        case .pageFolders:
