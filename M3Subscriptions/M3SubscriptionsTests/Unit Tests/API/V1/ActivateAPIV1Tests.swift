...
typealias ActivateAPI = API.V1.ActivateAPI
...
class ActivateAPIV1Tests: APITestCase {
    ...
    //MARK: - Success
    private func runSuccessfulActivationResponseTest(isExpired: Bool = false, renewalStatus: RenewalStatus) async throws {
